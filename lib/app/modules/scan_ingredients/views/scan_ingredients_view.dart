...
class ScanIngredientsView extends GetView<ScanIngredientsController> {
  const ScanIngredientsView({super.key});
  @override
  Widget build(BuildContext context) {
    return StatusBar(
      child: Scaffold(
        appBar: const CustomAppBar(title: "Scan Ingredients"),
